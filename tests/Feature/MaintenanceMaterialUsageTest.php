...
class MaintenanceMaterialUsageTest extends TestCase
{
    ...
    public function test_empty_material_card_is_available_to_authorized_users(): void
    {
        ...
        $modal = file_get_contents(resource_path('views/vehicle/partials/maintenance-materials-modal.blade.php'));
        $list = file_get_contents(resource_path('views/vehicle/partials/maintenance-materials-list.blade.php'));
        $summary = file_get_contents(resource_path('views/vehicle/partials/maintenance-materials-summary.blade.php'));

        $this->assertStringContainsString('maintenance-materials-summary', $view);
        $this->assertStringContainsString('Gerenciar materiais', $summary);
        $this->assertStringContainsString('Adicionar material', $modal);
        $this->assertStringContainsString('Nenhum material lançado ainda.', $list);
    }
