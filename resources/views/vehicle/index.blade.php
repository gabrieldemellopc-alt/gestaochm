...
<div class="vehicles-page">
    ...
    <div class="vehicles-filters">
        ...
        <div class="filter-group">
            <label class="vehicles-filter-label" for="fleetRelationFilter">Frota</label>
            <select class="vehicles-filter" id="fleetRelationFilter" aria-label="Frota">
                @foreach(['internal' => 'Internos', 'aggregated' => 'Agregados', 'rented' => 'Alugados', 'all' => 'Toda a frota'] as $value => $label)
                    <option value="{{ $value }}" @selected($fleetRelation === $value)>{{ $label }}</option>
                @endforeach
            </select>
        </div>
                                ...
                                <div class="last-maintenance-cell">
                                    ...
                                    <strong>
                                        ...
                                        {{
                                            ...
                                            $vehicle->last_maintenance?->items?->first()?->procedure?->name

                                            ?? $vehicle->last_maintenance?->procedure?->name
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const fleetRelationFilter = document.getElementById('fleetRelationFilter');

    fleetRelationFilter?.addEventListener('change', () => {
        const url = new URL(window.location.href);
        url.searchParams.set('fleet_relation', fleetRelationFilter.value);
