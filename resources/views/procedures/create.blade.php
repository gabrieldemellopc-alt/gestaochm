...
<div class="procedures-form-page">
    ...
    <div class="procedures-form-header">
        ...
        <div>
            ...
            <p>
                Configure regras de validade, execução e campos operacionais.
            </p>
        </div>
                    ...
                    <div class="procedure-two-cols">
                        ...
                        <div class="form-group">
                            ...
                            <select
                                ...
                                class="form-input @error('can_be_internal') input-invalid @enderror"
                            >
                                <option
                                    value="1"
                                    @selected(old('can_be_internal', 1) == 1)
                                >
                                    Sim
                                </option>
                                ...
                                <option
                                    value="0"
                                    @selected(old('can_be_internal') == 0)
                                >
                                    Não
                                </option>
                            </select>
                ...
                <div class="procedure-section">
                    ...
                    <div class="procedure-section-header with-action">
                        ...
                        <div>
                            ...
                            <p>
                                Adicione os campos complementares que deverão ser preenchidos ao executar este procedimento.
                            </p>
                        </div>
                    ...
                    <div
                        id="procedure-fields-wrapper"
                        class="procedure-fields-builder"
                    >
                        ...
                        @forelse($oldFields as $index => $field)
                    ...
                    >
                        ...
                        <div class="summary-empty" id="summaryEmpty">
                            ...
                            <div>
                                ...
                                <span>
                                    O procedimento será executado manualmente, sem controle por KM, horas ou período.
                                </span>
                            </div>
