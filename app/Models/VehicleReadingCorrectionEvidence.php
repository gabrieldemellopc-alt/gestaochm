...
class VehicleReadingCorrectionEvidence extends Model
{
    ...
    protected $fillable = ['tenant_id', 'vehicle_id', 'correction_id', 'initiated_by', 'token_hash', 'expires_at', 'used_at', 'status', 'evidence_type', 'disk', 'path', 'original_name', 'mime_type', 'size_bytes', 'duration_seconds', 'checksum'];
