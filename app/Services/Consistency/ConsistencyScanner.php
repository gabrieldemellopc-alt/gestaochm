...
class ConsistencyScanner
{
    ...
    private function contextFor(array $details): string { $encoded=json_encode($details); return str_contains((string)$encoded,'fuel_filling_import') ? 'historical' : 'current'; }
