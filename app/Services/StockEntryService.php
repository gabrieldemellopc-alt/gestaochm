...
class StockEntryService
{
    public function record(StockItem $item, array $data, array $audit = []): StockMovement
    {
        ...
        $movement = StockMovement::create([
            ...
            'invoice_number' => $data['invoice_number'] ?? null, 'supplier_name' => $data['supplier_name'] ?? null, 'supplier_id'=>$data['supplier_id']??null, 'supplier_document'=>$data['supplier_document']??null,
