    ...
    'groups' => [
        ...
        'maintenance' => [
            ...
            'permissions' => [
                ...
                'maintenance.upload_photos' => ['label' => 'Anexar fotos da manutenção', 'default' => ['supervisor' => true]],
                'maintenance.delete_photos' => ['label' => 'Remover fotos da manutenção', 'default' => ['supervisor' => true]],
                'maintenance.generate_photo_qr' => ['label' => 'Gerar QR para fotos', 'default' => ['supervisor' => true]],
        ...
        'stock' => [
            ...
            'permissions' => [
                ...
                'stock.view_item_details' => ['label' => 'Ver detalhamento dos itens do estoque', 'default' => ['supervisor' => false]],
